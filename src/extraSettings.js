...
// 指定生成的水果
var minRandomFruitNum = 0; // 生成随机水果最小值（0-10）
var maxRandomFruitNum = 5; // 生成随机水果最大值（1-11）
var setFruits = {
...
var fruitSlowDown = false;

// 广告链接：false 或为空字符串表示不会跳转到广告
var adLink = "";

// 修改网页标题：将 "合成大西瓜" 进行替换
// document.getElementsByTagName("title")[0].innerText = "合成鬼畜全明星";

// 开启选分弹窗：将 false 改为 true
var selectModal = false;

// 水果合成反转：false 改为 true（尚未支持）
var reverseLevelUp = false;
